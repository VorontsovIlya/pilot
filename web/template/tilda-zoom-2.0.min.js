...
function t_showZoom() {
  $('.t-zoomable').click(function (e) {
    ...
    if ($("#" + id + "").find(".t-slds").length) {
      ...
      images = slider.find(".t-zoomable")
    }
    images.each(function () {
      var images_urls = $(this).attr('data-img-zoom-url').split(',');
      if ($(this).is("img")) {
        var imgtitle = $(this).attr('title');
        var imgdescr = $(this).attr('data-img-zoom-descr')
      }
      if ($(this).is("div")) {
        var imgtitle = $(this).attr('title');
        var imgdescr = $(this).attr('data-img-zoom-descr')
      ...
      if (typeof imgtitle !== "undefined" && imgtitle !== !1) {
        var titlebody = "<div class=\"t-zoomer__title t-name t-descr_xxs\">" + imgtitle + "</div>"
      } else {
        var titlebody = ""
      }
      if (typeof imgdescr !== "undefined" && imgdescr !== !1) {
        var descrbody = "<div class=\"t-zoomer__descr t-descr t-descr_xxs\">" + imgdescr + "</div>"
      } else {
        var descrbody = ""
      }
    ...
    pos = parseFloat($(".t-carousel__zoomer__item:visible").attr("data-zoomer-slide-number"));
