...
function t_handleGoogleApiReady(recid) {
  $('#rec' + recid).find('.t-map').each(function (index, Element) {
    ...
    var myLatLng = arMarkers.length > 0 ? new google.maps.LatLng(parseFloat(arMarkers[0].lat), parseFloat(arMarkers[0].lng)) : !1;
    var myOptions = {
    ...
    if (arMarkers.length > 1) {
      ...
      var listener = google.maps.event.addListener(map, "idle", function () {
        if (map.getZoom() > parseInt(el.attr('data-map-zoom')) || map.getZoom() == 0) {
