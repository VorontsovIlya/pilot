...
function t_animate__startAnimation() {
  ...
  (void 0 !== a && 0 != a.length || void 0 !== n && 0 != n.length || void 0 !== e && 0 != e.length) && (t_animate__setAnimationState(a, e, n), a = a.filter(".r:has(.t-animate_wait)"), n = n.filter(".t-animate_wait"), e = e.filter(".r:has(.t-animate_wait)"), t(), $(window).bind("resize", t_throttle(t, 200)), setInterval(t, 5e3), $(window).bind("scroll", t_throttle(function () {
...
function t_animate__animateOnScroll(t, a, e) {
  if (0 != t.length || 0 != a.length || 0 != e.length) {
    var n = $(window).scrollTop(),
      i = n + $(window).height();
    if ($("body").is(":animated")) {
      for (s = 0; s < t.length; s++) t[s].curTopOffset <= n && $(t[s]).find(".t-animate").removeClass("t-animate t-animate_wait t-animate_no-hover");
      for (var s = 0; s < e.length; s++) e[s].curTopOffset <= n && $(e[s]).removeClass("t-animate t-animate_no-hover")
    }
...
function t_animate__animateChainItemsOnScroll(t, a, e) {
  ...
  for (var l = 0; l < i.length; l++) {
    ...
    if (!(f < e)) break;
    f != o && (d.addClass("t-animate__chain_first-in-row"), s = ++r, o = f);
    var c = .16 * s + m + _;
    d.css("transition-delay", c + "s"), d.removeClass("t-animate_wait"), d.addClass("t-animate_started"), d.attr("data-animate-start-time", Date.now() + 1e3 * c), d[0] == i.last()[0] && t_animate__checkSectionButtonAnimation(n, c), f == o && s++, i.splice(l, 1), t[a].itemsOffsets.splice(l, 1), l--
  }
...
function t_animate__animateElems(t, a) {
  if (t.length)
    for (var e = 0; e < t.length; e++) {
      ...
      t[e].curTopOffset < n && ($(t[e]).removeClass("t-animate_wait"), t_animate__removeNoHoverClassFromBtns($(t[e])), $(t[e]).addClass("t-animate_started"), t.splice(e, 1), e--)
    }
}
...
function t_animate__setAnimationState(t, a, e) {
  ...
  t.each(function () {
    ...
    var t = $(this),
      a = t.offset().top;
    if (a < n - 500) return t.removeClass("t-animate t-animate_no-hover"), !0;
    var e = t_animate__detectElemTriggerOffset(t, i);
    t_animate__setCustomAnimSettings(t, a, i), a < e && (t_animate__removeNoHoverClassFromBtns(t), t.addClass("t-animate_started")), a >= e && t.addClass("t-animate_wait")
...
function t_animate__wrapTextWithOpacity() {
  $(".t-title.t-animate,.t-descr.t-animate,.t-uptitle.t-animate,.t-text.t-animate").each(function () {
    ...
    if (void 0 !== a && a.indexOf("opacity") >= 0) {
      ...
      if (a.slice(e).indexOf(";") >= 0) n = a.slice(e, e + a.slice(e).indexOf(";"));
      else var n = a.slice(e);
